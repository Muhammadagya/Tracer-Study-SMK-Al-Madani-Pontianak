...
<div class="col-12 col-xl-8 mb-4 mb-xl-0">
  ...
  <h6 class="font-weight-normal mb-0">Ayo segera isi data kamu guna meningkatkan mutu pendidikan di SMK Al-Madani Pontianak!</h6>
</div>
...
<div class="col-12 col-xl-8 mb-4 mb-xl-0 mt-4">
  ...
  <h6 class="font-weight-normal mb-0">5. Bagi yang Belum Bekerja/Kuliah silahkan mengisi form yang telah disediakan.</h6>
    ...
    <div class="card-body">
      ...
      <form class="forms-sample">
        <div class="form-group">
          <label for="exampleInputUsername1">Masukkan Nama Lengkap Kamu</label>
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jurusan" id="jurusan1" value="">
              Rekayasa Perangkat Lunak (RPL)
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jurusan" id="jurusan2" value="">
              Teknik Komputer dan Jaringan (TKJ)
            </label>
          </div>
        </div>
        <div class="form-group">
          <label for="" class="mb-0">Tahun Lulus</label>
          <p  class="card-description">
            Contoh: 2023
          </p>
          <input type="text" class="form-control" id="" placeholder="Tahun lulus">
        </div>
        <div class="form-group">
          <label for="exampleInputUsername1">Alamat Rumah Saat Ini</label>
          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Alamat rumah">
        </div>
        <div class="form-group">
          <label for="exampleInputUsername1">Nomor Telepon/Hp</label>
          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nomor telepon/hp yang aktif">
        </div>
          <div class="form-group">
            <label>Kegiatan Kamu Saat Ini Setelah Lulus</label>
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="setelahLulus" id="setelahLulus1" value="">
                Bekerja
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="setelahLulus" id="setelahLulus2" value="">
                Wirausaha
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="setelahLulus" id="setelahLulus3" value="">
                Kuliah
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="setelahLulus" id="setelahLulus4" value="">
    ...
    <div class="card-body">
      ...
      <form class="forms-sample">
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan1" value="">
              D1
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan2" value="">
              D2
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan3" value="">
              D3
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan4" value="">
              D4
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan5" value="">
              S1
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan6" value="">
              S2
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="komptensiKeahlian" id="jenjangPendidikan7" value="">
              S3
            </label>
          </div>
        </div>
